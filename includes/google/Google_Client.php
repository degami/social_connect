...
if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
  $defaultConfig = $google_apiConfig;
  require_once (dirname(__FILE__)  . '/local_config.php');
  $google_apiConfig = array_merge($defaultConfig, $google_apiConfig);
}
...
class Google_Client {
  ...
  public function __construct($config = array()) {
    ...
    $google_apiConfig = array_merge($google_apiConfig, $config);
    self::$cache = new $google_apiConfig['cacheClass']();
    self::$auth = new $google_apiConfig['authClass']();
    self::$io = new $google_apiConfig['ioClass']();
  }
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($google_apiConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $google_apiConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    global $google_apiConfig;
    $google_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $google_apiConfig;
    $google_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $google_apiConfig;
    $google_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $google_apiConfig;
    $google_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $google_apiConfig;
    $google_apiConfig['use_objects'] = $useObjects;
  }
